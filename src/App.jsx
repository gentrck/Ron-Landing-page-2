...
import { Calendar, CreditCard, Shield, Star, CheckCircle2, Phone, PlayCircle, Quote, Filter } from "lucide-react";
...
//   Source: tampahypnosiscenter.com/contact-tampa-fl-hypnosis-clinic/
// - Headshot: using site asset placeholder (replace with Ron's actual headshot URL if available)
//   Example used: tampahypnosiscenter.com/wp-content/uploads/tampa-hypnosis-center-logo-v3.png
...
const videos = [
  {
    ...
    url: "https://www.youtube.com/watch?v=XX4JR2fKq3g", // if this 404s, replace with any channel video URL
  },
  {
    id: "vid2",
...
function YouTubeThumb({ url, title }) {
  // Simple thumbnail card that opens the video in a new tab
  return (
...
export default function RonQueeneyLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 text-slate-900">
      ...
      <header className={`sticky top-0 z-50 border-b bg-white/80 backdrop-blur-lg`}> 
        <Container className="flex h-16 items-center justify-between">
          <a href="#top" className="flex items-center gap-3">
            <div className={`h-9 w-9 rounded-xl bg-gradient-to-tr ${brand.primary} shadow-inner`} />
        ...
        <Container>
          <div className="grid items-center gap-10 md:grid-cols-2">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="relative">
              <div className={`absolute -inset-6 -z-10 rounded-3xl bg-gradient-to-tr ${brand.primary} opacity-10`} />
      ...
      {/* FOOTER */}
      <footer className={`mt-10 border-t bg-gradient-to-tr ${brand.primary} text-white`}>
